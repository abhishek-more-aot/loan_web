...
<header id="header" class="header navbar-fixed-top">
    <div class="container">
        <h1 class="logo">
            <a href="index.php" style="padding:0;margin-top:0;background:none;"><img src="/assets/images/logo/logo(test).png" class="logo-img"></a>
        </h1>
        <!--//logo-->
        <nav class="main-nav navbar-right" role="navigation">
            ...
            <div id="navbar-collapse" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class=" activenav-item"><a href="index.php">Home</a></li>
